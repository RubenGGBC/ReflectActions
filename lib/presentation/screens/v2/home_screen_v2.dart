            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: hasData
                  ...
                  BoxShadow(
                    color: isToday
                        ? MinimalColors.success.withValues(alpha: 0.4)
...
// ============================================================================
  ...
  Widget _buildGoalCard(dynamic goal) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isCompleted
            ? MinimalColors.success.withValues(alpha: 0.1) // Verde suave para completados
            : MinimalColors.backgroundSecondary(context),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: isCompleted
              ? MinimalColors.success.withValues(alpha: 0.3) // Borde verde para completados
          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isCompleted
                      ? MinimalColors.success // Verde sólido para completados
                  ...
                  if (snapshot.hasData && snapshot.data != null) {
                    return Container(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          // Only open if there's an image
                          if (snapshot.hasData && snapshot.data != null) {
                            // Open expandable moment detail widget with glowing borders
                            Navigator.of(context).push(
                              PageRouteBuilder(
                                pageBuilder: (context, animation, secondaryAnimation) => 
                                  ExpandableMomentDetailWidget(
                        ...
                        child: ClipRRect(
                          ...
                          child: Stack(
                            children: [
                              ...
                              // Add subtle overlay to indicate it's tappable
                              Positioned.fill(
                                child: Container(
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(8),
                              ...
                              // Add zoom icon to indicate interactivity
                              Positioned(
                                top: 4,
                                right: 4,
                                child: Container(
